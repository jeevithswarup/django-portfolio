...
class Intro(models.Model):
        ...
        resume_pdf =models.ImageField(upload_to="resume_pdf/",storage=ImageStorage(),blank=True,null=True)
...
#     project_pdf = models.FileField(upload_to="project_pdfs/",blank=True,null=True)
    ...
    project_pdf = models.ImageField(upload_to="project_pdfs/",storage=ImageStorage(),blank=True,null=True)
...
class AcademicQualification(models.Model):
     ...
     result_pdf=models.ImageField(upload_to='results/',storage=ImageStorage(),blank=True,null=True)
     def __str__(self):
          return self.qualification

class Certificates(models.Model):
     certificate_pdf=models.ImageField(upload_to='certificates/',storage=ImageStorage(),blank=True,null=True)    
...
class Semester(models.Model):
     ...
     semester_result=models.ImageField(upload_to='sem_results/',storage=ImageStorage(),blank=True,null=True)
     def __str__(self):
